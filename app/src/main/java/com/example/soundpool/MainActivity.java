...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPlay.setOnClickListener(view -> mediaPlayerData(R.raw.success));
    }

    private void mediaPlayerData(int mediaType) {
        ...
        final int voiceId = soundPool.load(this, mediaType, 1);
        //异步需要等待加载完成，音频才能播放成功
